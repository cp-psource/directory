...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?>>
    <head profile="http://gmpg.org/xfn/11">
        ...
        <link rel="icon" href="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/favicon.ico" type="images/x-icon" />
        <?php do_action('dir_theme_colors'); ?>
        <?php do_action('dir_theme_options'); ?>
        <link rel="stylesheet" href="<?php echo esc_url(get_template_directory_uri()); ?>/css/custom.css" type="text/css" media="all" />
