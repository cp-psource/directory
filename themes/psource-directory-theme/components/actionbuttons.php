<div id="action-bar">
	...
	<div id="submit-site"><?php echo do_shortcode('[dr_signin_btn view="always" text="' . __('Einloggen',THEME_TEXT_DOMAIN ) . '"]'); ?></div>
	<?php else: ?>
	<form id="log-out" action="#" method="post">
		<input type="submit" name="directory_logout" value="<?php _e('Ausloggen', THEME_TEXT_DOMAIN); ?>" />
	</form>
	<?php 
	...
	<form id="go-to-profile" action="#" method="post">
		<input type="submit" name="redirect_profile" value="<?php _e('Gehe zum Profil', THEME_TEXT_DOMAIN); ?>" />
	</form>
	<?php endif; ?>
