<!-- start messages -->
<?php if ( is_category() ): ?>
	<h3><?php _e("Leider können wir die von Dir gesuchte Kategorie unter dieser URL nicht finden. Bitte versuche, einen Menüpunkt oben oder neben dieser Nachricht auszuwählen, um dorthin zu gelangen, wo Du hin möchtest.", THEME_TEXT_DOMAIN); ?></h3>
...
<?php elseif ( is_search() ): ?>
	<h3><?php _e("Leider können wir den von Dir gesuchten Suchbegriff nicht finden. Bitte versuche, einen Menüpunkt oben oder neben dieser Nachricht auszuwählen, um dorthin zu gelangen, wo Du hin möchtest.", THEME_TEXT_DOMAIN); ?></h3>
