...
<div id="content"><!-- start #content -->
	<div class="padder">
		<div class="page" id="blog-single"><!-- start #blog-single -->
			...
			<h3><?php _e("Sorry, we can't find the post you're looking for at this URL. Bitte versuche, einen Menüpunkt oben oder neben dieser Nachricht auszuwählen, um dorthin zu gelangen, wo Du hin möchtest.", THEME_TEXT_DOMAIN); ?></h3>
