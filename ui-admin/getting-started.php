...
<div id="dr-plugin-setting" class="wrap">
	...
	<div class="metabox-holder">
		...
		<div class="postbox">
			...
			<div class="inside">
				<ul>
					<li><a href="https://n3rds.work/docs/verzeichnis-handbuch/" target="_blank"><?php _e( 'Plugin-Projektseite', $this->text_domain ); ?></a></li>
					<li><a href="https://n3rds.work/docs/verzeichnis-handbuch/" target="_blank"><?php _e( 'Installations- und Anleitungsseite', $this->text_domain ); ?></a></li>
					<!--<li><a href="#" target="_blank"><?php _e( 'Videoanleitung', $this->text_domain ); ?></a></li>-->
					<li><a href="https://n3rds.work/docs/verzeichnis-handbuch/" target="_blank"><?php _e( 'Hilfeforum', $this->text_domain ); ?></a></li>
				</ul>
			</div>
		</div>
		<?php } ?>
